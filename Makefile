...
dev:
	...
	@docker build --pull --no-cache -t $(REGISTRY):10000/fraguinha/stand-backend:latest src/backend
	@docker build --pull --no-cache -t $(REGISTRY):10000/fraguinha/stand-frontend:latest src/frontend
	@docker push $(REGISTRY):10000/fraguinha/stand-backend:latest
	@docker push $(REGISTRY):10000/fraguinha/stand-frontend:latest
